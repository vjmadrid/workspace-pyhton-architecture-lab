...
class OperationWebdriverWait:
    ...
    def webdriverwait_default(locator, driver, delay, until_element_ec):
        ...
        return OperationWebdriverWait.webdriverwait(locator, driver, delay, until_element_ec, False, False)
    ...
    def test_webdriverwait_default(locator, driver, delay, until_element_ec):
        ...
        return OperationWebdriverWait.webdriverwait(locator, driver, delay, until_element_ec, False, True)
    ...
    def retry_webdriverwait(
        ...
        # Last attempt
        return OperationWebdriverWait.webdriverwait(
    ...
    def retry_webdriverwait_default(locator, driver, delay, until_element_ec, max_retries):
        ...
        return OperationWebdriverWait.retry_webdriverwait(
