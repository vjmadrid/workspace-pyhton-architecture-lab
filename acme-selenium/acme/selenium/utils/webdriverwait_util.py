...
def webdriverwait_when_visible(driver: WebDriver, locator, wait_seconds=1):
    ...
    return webdriverwait_until_condition(driver, EC.presence_of_element_located(locator), wait_seconds)
...
def webdriverwait_when_all_visible(driver: WebDriver, locator, wait_seconds=1):
    ...
    return webdriverwait_until_condition(driver, EC.visibility_of_any_elements_located(locator), wait_seconds)
...
def get_when_invisible(driver: WebDriver, locator, wait_seconds=1):
    ...
    return webdriverwait_until_condition(driver, EC.invisibility_of_element_located(locator), wait_seconds)
...
def webdriverwait_until_not_present(driver: WebDriver, locator):
    ...
    webdriverwait_until_condition(driver, lambda d: len(d.find_elements(*locator)) == 0)
...
def webdriverwait_when_clickable(driver: WebDriver, locator, wait_seconds=1):
    ...
    return webdriverwait_until_condition(driver, EC.element_to_be_clickable(locator), wait_seconds)


def webdriverwait_for_element_text(driver: WebDriver, by, locator, text: str, wait_seconds=1):
    ...
    return webdriverwait_until_condition(driver, EC.text_to_be_present_in_element(by, locator), wait_seconds)
