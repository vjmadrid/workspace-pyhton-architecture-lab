...
NAME = "acme-selenium"
DESCRIPTION = "Architecture library (dependency) related with selenium to develop the different parts in \
    a homogeneus way"
URL = "https://github.com/vjmadrid/workspace-python-architecture-lab/tree/main/acme-selenium"
EMAIL = "vjmadrid"
